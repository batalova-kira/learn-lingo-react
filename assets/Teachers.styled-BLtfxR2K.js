import{u as t,G as y,j as o,r as W,c as j,b as $,i as R,k as H,l as I,B as S,t as _,N as A}from"./index-DAFXTIg4.js";import{T as D,I as b,M as P,a as E,s as N}from"./SignUp.styled-CuMlIjNS.js";const Z=t.div`
    display: flex;
    /* gap: 48px; */
...
`,fe=t.p`
    ...
    line-height: 1.5;
    color: ${e=>e.theme.colors.black};
`,ue=({review:e})=>{const{reviewer_name:n,reviewer_rating:i,comment:r}=e;return o.jsx(o.Fragment,{children:o.jsxs("div",{children:[o.jsxs(T,{children:[o.jsx("img",{}),o.jsxs("div",{children:[o.jsx(xe,{children:n}),o.jsxs(ge,{children:[o.jsx("img",{src:L,alt:"star rating"}),o.jsx(me,{children:i.toFixed(1)})]})]})]}),o.jsx(fe,{children:r})]})})},Ie=e=>e.filters.filterLanguage,ve=e=>e.filters.filterLevel,Se=e=>e.filters.filterPrice,be=t(D)`
    margin-bottom: 20px;
`,ke=t.img`
    border-radius: 100px;
    width: 44px;
...
`;export{De as B,Ne as S,Ae as T,Pe as W,ve as a,Se as b,_e as c,Ee as d,Ie as s};
