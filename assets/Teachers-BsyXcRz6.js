import{u as o,G as C,j as t,r as p,a as L,s as $,b as z,c as M,g as R,d as B,o as H,e as T}from"./index-mvXhiYyk.js";const D=o.div`
    display: flex;
    /* gap: 48px; */
...
`,_=o.img`
    ...
    left: 87px;
    position: absolute;
`,W="data:image/svg+xml,%3csvg%20width='12'%20height='12'%20viewBox='0%200%2012%2012'%20fill='none'%20xmlns='http://www.w3.org/2000/svg'%3e%3ccircle%20cx='6'%20cy='6'%20r='6'%20fill='white'/%3e%3ccircle%20cx='6'%20cy='6'%20r='4'%20fill='%2338CD3E'/%3e%3c/svg%3e";function A(e){return C({tag:"svg",attr:{viewBox:"0 0 512 512"},child:[{tag:"path",attr:{d:"M225.8 468.2l-2.5-2.3L48.1 303.2C17.4 274.7 0 234.7 0 192.8v-3.3c0-70.4 50-130.8 119.2-144C158.6 37.9 198.9 47 231 69.6c9 6.4 17.4 13.8 25 22.3c4.2-4.8 8.7-9.2 13.5-13.3c3.7-3.2 7.5-6.2 11.5-9c0 0 0 0 0 0C313.1 47 353.4 37.9 392.8 45.4C462 58.6 512 119.1 512 189.5v3.3c0 41.9-17.4 81.9-48.1 110.4L288.7 465.9l-2.5 2.3c-8.2 7.6-19 11.9-30.2 11.9s-22-4.2-30.2-11.9zM239.1 145c-.4-.3-.7-.7-1-1.1l-17.8-20c0 0-.1-.1-.1-.1c0 0 0 0 0 0c-23.1-25.9-58-37.7-92-31.2C81.6 101.5 48 142.1 48 189.5v3.3c0 28.5 11.9 55.8 32.8 75.2L256 430.7 431.2 268c20.9-19.4 32.8-46.7 32.8-75.2v-3.3c0-47.3-33.6-88-80.1-96.9c-34-6.5-69 5.4-92 31.2c0 0 0 0-.1 .1s0 0-.1 .1l-17.8 20c-.3 .4-.7 .7-1 1.1c-4.5 4.5-10.6 7-16.9 7s-12.4-2.5-16.9-7z"},child:[]}]})(e)}function I(e){return C({tag:"svg",attr:{viewBox:"0 0 512 512"},child:[{tag:"path",attr:{d:"M462.3 62.6C407.5 15.9 326 24.3 275.7 76.2L256 96.5l-19.7-20.3C186.1 24.3 104.5 15.9 49.7 62.6c-62.8 53.6-66.1 149.8-9.9 207.9l193.5 199.8c12.5 12.9 32.8 12.9 45.3 0l193.5-199.8c56.3-58.1 53-154.3-9.8-207.9z"},child:[]}]})(e)}const Z=o.div`
    display: flex;
    flex-direction: row;
...
`,c2=o.p`
    ...
    line-height: 1.5;
    color: ${e=>e.theme.colors.black};
`,a2=({review:e})=>{const{reviewer_name:n,reviewer_rating:i,comment:s}=e;return t.jsx(t.Fragment,{children:t.jsxs("div",{children:[t.jsxs(o2,{children:[t.jsx(n2,{}),t.jsxs("div",{children:[t.jsx(r2,{children:n}),t.jsxs(i2,{children:[t.jsx("img",{src:j,alt:"star rating"}),t.jsx(s2,{children:i.toFixed(1)})]})]})]}),t.jsx(c2,{children:s})]})})},l2=({item:e})=>{const[n,i]=p.useState(!1),s=L($),l=z(),r=c=>{l(M(c))},d=()=>{i(!n)},{languages:g,lesson_info:f,conditions:a,experience:m,reviews:k,levels:y}=e;return t.jsxs(t.Fragment,{children:[t.jsxs(J,{children:[t.jsxs(x,{children:["Speaks: ",t.jsx(b,{children:g.join(", ")})]}),t.jsxs(x,{children:["Lesson Info: ",t.jsx(b,{children:f})]}),t.jsxs(x,{children:["Conditions: ",t.jsx(b,{children:a.join(" ")})]})]}),!n&&t.jsx(K,{type:"button",onClick:d,children:"Read more"}),n&&t.jsxs(t.Fragment,{children:[t.jsx(Q,{children:m}),t.jsxs("div",{children:[k.map((c,v)=>t.jsx(a2,{review:c},v)),t.jsx(X,{children:y.map((c,v)=>t.jsx(Y,{onClick:()=>r(c),selected:s===c,children:c},v))}),t.jsx(e2,{children:"Book trial lesson"})]})]})]})},d2=({item:e})=>{const{name:n,surname:i,lessons_done:s,rating:l,price_per_hour:r}=e;return t.jsxs(V,{children:[t.jsxs(Z,{children:[t.jsx(P,{children:t.jsx(x,{children:"Languages"})}),t.jsxs(G,{children:[t.jsx(w,{src:q,alt:"book"}),t.jsx(h,{children:"Lessons online"}),t.jsx(u,{children:"|"}),t.jsxs(h,{children:["Lessons done: ",s]}),t.jsx(u,{children:"|"}),t.jsx(w,{src:j,alt:"star rating"}),t.jsxs(h,{children:["Rating: ",l]}),t.jsx(u,{children:"|"}),t.jsxs(h,{children:["Price / 1 hour:"," ",t.jsxs(N,{children:[r,"$"]})]}),t.jsx(O,{type:"button",children:t.jsx(U,{})})]})]}),t.jsxs(E,{children:[n," ",i]}),t.jsx(l2,{item:e})]})},h2=({item:e})=>{const{avatar_url:n}=e;return t.jsxs(D,{children:[t.jsxs(F,{children:[t.jsx(S,{src:n,alt:"teacher"}),t.jsx(_,{src:W,alt:"online status"})]}),t.jsx(d2,{item:e})]})},p2=o.ul`
    display: flex;
    flex-direction: column;
    gap: 32px;
    margin-bottom: 64px;
...
`,f2=()=>{const[e,n]=p.useState([]),[i,s]=p.useState(4);p.useEffect(()=>{const r=R(T),d=B(r),g=H(d,f=>{const a=f.val();if(console.log("Updated data:",a),a&&typeof a=="object"){const m=Object.values(a);n(m)}});return()=>{g()}},[]);const l=()=>{s(r=>r+4)};return t.jsxs(t.Fragment,{children:[t.jsx(p2,{children:e.slice(0,i).map((r,d)=>t.jsx("li",{children:t.jsx(h2,{item:r})},d))}),i<e.length&&t.jsx(x2,{onClick:l,children:"Load More"})]})};export{f2 as default};
